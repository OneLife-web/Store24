...
const CheckoutSideNav = () => {
  ...
  return (
    <aside className="max-w-xl h-screen w-full bg-secondary py-10 pl-7 pr-[7%]">
      ...
      <div className="grid gap-3 mt-3">
        ...
        <div className="flex items-center justify-between text-lg max-sm:text-base font-semibold">
          <p>Total</p>
          <p>${totalPrice}</p>
        </div>
      </div>
